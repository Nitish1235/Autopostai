...
exports.buildScriptSystemPrompt = buildScriptSystemPrompt;
exports.buildScriptUserPrompt = buildScriptUserPrompt;
exports.getDurationPerSegment = getDurationPerSegment;
exports.getNarrationLength = getNarrationLength;
exports.getSegmentCount = getSegmentCount;
exports.buildTopicGenerationPrompt = buildTopicGenerationPrompt;
...
function buildScriptUserPrompt(topic, niche, format, segmentCount) {
...
function getDurationPerSegment(format) {
    switch (format) {
        case '30s':
            return 3.5;
        case '60s':
...
function getNarrationLength(format) {
    switch (format) {
        case '30s':
            return 20;
        case '60s':
...
function getSegmentCount(format) {
    switch (format) {
        case '30s':
            return 11;
        case '60s':
...
function buildTopicGenerationPrompt(niche, count, existingTopics) {
